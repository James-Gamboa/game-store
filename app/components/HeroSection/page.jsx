  ...
  return (
    <>
      <div>
        ...
        <p>
          Explore our vast library of games across all platforms. From indie gems to
          AAA blockbusters, find the perfect game at the perfect price.
        </p>
      ...
      <main className="bg-gray-100 min-h-screen p-4">
        <section className="relative w-full max-w-6xl mx-auto overflow-hidden rounded-lg shadow-lg">
          ...
          <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center px-6 sm:px-10 lg:px-16 text-white z-20">
            <span className="inline-block bg-blue-500 text-white text-sm font-semibold px-1 py-1 rounded-full mb-2">
              New Release
            </span>
